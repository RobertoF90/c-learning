/* displays the closest flight time to another city in 24h format.
 * gets inputs from user in 12h format
...
int main(void)
{
	...
	int departure_pm = 0, arrival_pm = 0;
